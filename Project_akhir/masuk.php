...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php">sFER</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                               <!-- Button to Open the Modal -->
                                    ...
                                    <a href="exportbrgmasuk.php" class="btn btn-outline-success"> Export Data  <i class="fas fa-file-export"></i></a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <?php
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="post">
                                                    ...
                                                    <input type="number" name="qty" value="<?=$qty;?>" class="form-control"><br>
                                                    ...
                                                    <button type="submit" class="btn btn-success" name="updatebarangmasuk">Update</button>
                                                    </div>
                                                </form>
                                            </div>
                                            </div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; 2021 | sFer</div>
                        </div>
                    </div>
                </footer>
            </div>
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            ...
            <form method="post">
                ...
                <br>
                <input type="text" name="penerima" placeholder="Penerima" class="form-control"><br>
