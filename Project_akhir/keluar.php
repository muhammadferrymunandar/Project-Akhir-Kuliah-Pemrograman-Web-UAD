                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                               <!-- Button to Open the Modal -->
                                    ...
                                    <a href="exportbrgkeluar.php" class="btn btn-outline-success"> Export Data  <i class="fas fa-file-export"></i></a>
                            </div>
                            <div class="card-body">
    ...
    <div class="modal fade" id="myModal">
        ...
        <div class="modal-content">
            ...
            <form method="post">
                ...
                <br>
                <input type="text" name="penerima" placeholder="Pembeli" class="form-control"><br>
