                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                               <!-- Button to Open the Modal -->
                                    ...
                                    <a href="exportstock.php" class="btn btn-outline-success"> Export Data  <i class="fas fa-file-export"></i></a>
                            </div>
                            <div class="card-body">
                                <?php
                                    ...
                                    while($fetch=mysqli_fetch_array($ambildatastock)){
                                            $nmbarang=$fetch['namabarang'];
                                    
                                ?>
                                <div class="alert alert-danger alert-dismissible">
                                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                                    <strong>Perhatian!</strong> Stock Barang <?=$nmbarang;?> habis.
                                </div>
                                <?php
                                    }
                                ?>
                                    ...
                                    <tbody>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="post">
                                                ...
                                                <input type="number" name="stock" value="<?=$stock;?>" class="form-control"><br>
